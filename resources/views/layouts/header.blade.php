...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="libs/AdminLTE/plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  ...
  <link rel="stylesheet" href="libs/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">

  <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
  <!--[if lt IE 9]>
  <script src="libs/AdminLTE/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="libs/AdminLTE/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
</head>
...
<div class="wrapper" style="margin-top:50px">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Promotion</b></span>
    </a>
      ...
      <!-- Sidebar toggle button-->
        <div class="navbar-custom-menu" style="float:left;">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="/creative" class="dropdown-toggle" aria-expanded="false">
                        <i class="fa fa-file"></i>
                       内容管理
                    </a>
                </li>
                <li class="dropdown">
                    <a href="/tripartite/inspectYellowSearch" class="dropdown-toggle" aria-expanded="false">
                        <i class="fa fa-file"></i>
                       腾讯鉴黄
                    </a>
                </li>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="libs/AdminLTE/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="libs/AdminLTE/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
